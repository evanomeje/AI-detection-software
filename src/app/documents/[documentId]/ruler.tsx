...
export const Ruler = () => {
        ...
        if ((isDraggingLeft || isDraggingRight ) && rulerRef.current) {
            ...
            if (container) {
                ...
                if (isDraggingLeft) {
                    ...
                    const maxRightPositon = 816 - (leftMargin + 100);
                    const newRightPosition = Math.max(816 - rawPosition, 0);
                    const constrainedRightPosition = Math.min(newRightPosition, maxRightPositon);
    ...
    return (
        ...
        className="mx-auto w-[816px] h-6 border-b border-gray-300 flex items-end relative select-none print:hidden">
            <div
                id="ruler-container"
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {marker %  5 === 0 && marker % 10 !== 0 && (
                                        <div className="absolute bottom-0 w-[1px] h-1.5 bg-neutrual-500" />
